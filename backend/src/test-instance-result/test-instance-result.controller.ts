...
export class TestInstanceResultController {
  constructor(
    private readonly testInstanceResultService: TestInstanceResultService,
  ) {}
  ...
  update(
    @Param('id') id: string,
    @Body() updateTestInstanceResultDto: UpdateTestInstanceResultDto,
  ) {
    return this.testInstanceResultService.update(
      +id,
      updateTestInstanceResultDto,
    );
  }
